...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  // Re-fetches the profile without touching `loading` — used after Settings
  // edits its own name/phone, so the sidebar and everywhere else showing
  // `profile.name` update immediately instead of only after a full reload.
