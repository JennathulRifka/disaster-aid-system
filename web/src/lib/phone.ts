// Mirrors server/src/utils/phone.js — client-side copy so Register.tsx can
// validate before submitting, not a round trip. The server re-validates
// (and is the authoritative check) regardless.
